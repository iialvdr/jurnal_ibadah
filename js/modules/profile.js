...
export function initProfile() {
    ...
    modals.forEach(({ id, contentId }) => {
        ...
        if (c) {
            ...
            // Pastikan pakai translate3d untuk GPU
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    displayColors: false,
                    callbacks: {
                        label: function(context) { return context.parsed.y + ' Wajib'; }
                    }
                }
            },
            scales: {
