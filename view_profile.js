...
<div id="profileView" class="hidden-force flex flex-col h-full absolute inset-0 z-50 transition-all duration-300 bg-slate-50/50 dark:bg-slate-950/50 backdrop-blur-sm">
    
    <div class="pt-[calc(3rem+env(safe-area-inset-top))] px-6 pb-8 rounded-b-[2.5rem] shadow-sm relative shrink-0 
        bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/30">
        
        <button onclick="closeProfile()" class="absolute top-[calc(1.5rem+env(safe-area-inset-top))] left-6 p-2 rounded-full shadow-sm transition
    ...
    <div class="p-6 space-y-4 overflow-y-auto flex-1 pb-[calc(8rem+env(safe-area-inset-bottom))]">
        
        <div class="grid grid-cols-2 gap-3 mb-2">
            <div class="p-4 rounded-2xl shadow-sm flex flex-col items-center justify-center bg-white/40 dark:bg-slate-800/40 backdrop-blur-md border border-white/40 dark:border-slate-700/30">
        ...
        <div class="rounded-2xl p-5 shadow-sm bg-white/40 dark:bg-slate-800/40 backdrop-blur-md border border-white/40 dark:border-slate-700/30">
        ...
        <div class="rounded-2xl p-5 shadow-sm bg-white/40 dark:bg-slate-800/40 backdrop-blur-md border border-white/40 dark:border-slate-700/30">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between text-sm"><span class="text-slate-500 dark:text-slate-400">Bergabung</span><span id="joinDate" class="font-medium text-slate-700 dark:text-slate-200">-</span></div>
                <div class="flex items-center justify-between text-sm"><span class="text-slate-500 dark:text-slate-400">Lokasi</span><span id="lastLocation" class="font-medium text-slate-700 dark:text-slate-200">-</span></div>
            </div>
        </div>

        <button id="logoutBtnProfile" class="w-full mt-4 p-4 rounded-2xl font-medium border transition flex items-center justify-center gap-2 mb-8 bg-red-50/50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-red-100/50 dark:border-red-900/30 hover:bg-red-100/50 backdrop-blur-sm">
