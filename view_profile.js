...
<div id="profileView" class="hidden-force flex flex-col h-full absolute inset-0 z-50 transition-all duration-300">
    ...
    <div class="p-6 space-y-4 overflow-y-auto flex-1 pb-32">
        ...
        <button id="logoutBtnProfile" class="w-full mt-4 p-4 rounded-2xl font-medium border transition flex items-center justify-center gap-2 mb-8 bg-red-50/50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-red-100/50 dark:border-red-900/30 hover:bg-red-100/50 backdrop-blur-sm"><i data-lucide="log-out" class="w-4 h-4"></i> Keluar Aplikasi</button>
    </div>
</div>
`;